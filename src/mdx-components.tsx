...
export function useMDXComponents(components: MDXComponents): MDXComponents {
  return {
    ...
    h2: (props) => (
      <h2 className="text-3xl font-black pb-4 pt-2 w-full" {...props} />
    ),
    h3: (props) => (
      <h3 className="text-2xl font-bold pb-2 pt-2 w-full" {...props} />
    ),
    h4: (props) => <h4 className="text-xl font-bold pb-4 w-full" {...props} />,
    h5: (props) => <h5 className="text-lg font-bold pb-4 w-full" {...props} />,
    h6: (props) => (
      <h6 className="text-base font-bold pb-4 w-full" {...props} />
    ),
